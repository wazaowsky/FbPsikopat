...
print '\x1b[1;32mkalo gk punya, belilah'
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6283865232904&text=woi zx gans aing hayang beli login termux')
...
if sandi == '*#*#*#*#' and user == 'marioXploit':
    ...
    print 'Login GAGAL, Silahkan hubungi zx eaa'
    wa()
    restart()
